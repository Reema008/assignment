...
var isUser = function (obj) {
	...
	if(typeof obj==="object"){
		...
		keys.forEach(function(element){
		 if((element=="name")||(element=="screen_name"))
		 	c++;
	});
		if(c==keys.length)
			return true;
...
console.log(isUser("semmypurewal"));
console.log(isUser({ "age": 37, "name":"Semmy Purewal", "screen_name":"semmypurewal" }));
...
console.log(userToDiv({ "name":"Firstname Lastname", "screen_name":"user" }));
console.log(userToDiv("semmypurewal"));
console.log(userToDiv({ "age": 37, "name":"Semmy Purewal", "screen_name":"semmypurewal" }));
